-- Migration: Create notification trigger for task assignments
-- Run this SQL in your Supabase SQL Editor (https://supabase.com/dashboard/project/facadidhognljvafbcii/sql)
...
BEGIN
  ...
  END IF;
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'notifications' AND column_name = 'row_id') THEN
...
-- ============================================================
-- 2. Create index for faster unread count queries
-- ============================================================
